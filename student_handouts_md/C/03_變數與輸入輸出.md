...
![scanf 使用變數位址保存輸入](images/lesson_03/C_Lesson_03_img06_scanf_address.png)
...
![變數是具有名稱型態與內容的資料盒子](images/lesson_03/C_Lesson_03_img01_variable_box.png)
...
![宣告初始化賦值與重新賦值](images/lesson_03/C_Lesson_03_img02_declaration_assignment.png)
...
![賦值敘述的閱讀方向](images/lesson_03/C_Lesson_03_img03_assignment_direction.png)
...
![printf 格式代碼與變數的對應](images/lesson_03/C_Lesson_03_img04_printf_format_mapping.png)
...
![scanf 敘述中每個部分的用途](images/lesson_03/C_Lesson_03_img05_scanf_anatomy.png)
...
![輸入處理輸出的程式流程](images/lesson_03/C_Lesson_03_img07_input_process_output.png)
...
![兩數總和程式的變數追蹤](images/lesson_03/C_Lesson_03_img08_sum_variable_tracking.png)
...
![使用同一個變數逐次累加](images/lesson_03/C_Lesson_03_img09_accumulation.png)
...
![使用 temp 交換兩個變數](images/lesson_03/C_Lesson_03_img10_swap_with_temp.png)
