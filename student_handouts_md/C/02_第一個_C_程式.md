...
![printf 敘述中每個符號的用途](images/lesson_02/C_Lesson_02_img03_printf_anatomy.png)
...
![程式碼換行與輸出換行的差異](images/lesson_02/C_Lesson_02_img04_code_line_vs_output_line.png)
...
![修改儲存編譯執行流程](images/lesson_02/C_Lesson_02_img12_edit_compile_run_cycle.png)
...
![C 程式的基本結構](images/lesson_02/C_Lesson_02_img01_program_structure.png)
...
![第一個 C 程式的執行流程](images/lesson_02/C_Lesson_02_img02_execution_flow.png)
...
![main 函式的程式區塊](images/lesson_02/C_Lesson_02_img09_main_block.png)
...
![C 語言常見跳脫序列](images/lesson_02/C_Lesson_02_img05_escape_sequences.png)
...
![在 C 字串中顯示雙引號與反斜線](images/lesson_02/C_Lesson_02_img06_quote_and_backslash.png)
...
![Tab 定位點與欄位間隔](images/lesson_02/C_Lesson_02_img10_tab_stops.png)
...
![文字圖形的拆解與輸出流程](images/lesson_02/C_Lesson_02_img07_text_art_workflow.png)
...
![註解與可執行程式碼的差異](images/lesson_02/C_Lesson_02_img11_comments.png)
...
![printf 常見語法錯誤](images/lesson_02/C_Lesson_02_img08_common_syntax_errors.png)
